...
$vulnerabilities_by_family = [];
$vulnerabilities_by_category = [];
$vulnerabilities_by_vendor = [];
$vulnerabilities_by_product = []; // Nouvelle statistique pour les produits
...
arsort($vulnerabilities_by_family);
arsort($vulnerabilities_by_category);
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card h-100">
                            <div class="card-body text-center">
                                <h3 class="text-danger"><?= formatNumber(count($vulnerabilities_by_category)) ?></h3>
                                <div class="text-muted">Catégories de produits</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="card h-100">
                            <div class="card-body text-center">
                                <h3 class="text-success"><?= formatNumber(count($vulnerabilities_by_family)) ?></h3>
                                <div class="text-muted">Familles de produits</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="card h-100">
                            <div class="card-body text-center">
                                <h3 class="text-info"><?= formatNumber(count($vulnerabilities_by_vendor)) ?></h3>
                ...
                <form action="" method="GET" class="row g-3">
                    ...
                    <div class="col-md-3">
                        <select name="search_field" class="form-select">
                            ...
                            <option value="Category" <?= ($search_field == 'Category') ? 'selected' : '' ?>>Catégorie</option>
                            <option value="Family" <?= ($search_field == 'Family') ? 'selected' : '' ?>>Famille</option>
                        </select>
                    </div>
                    <div class="col-md-5">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-bordered">
                        <thead class="table-dark">
                            <tr>
                                <th>
                                    <a href="?sort=Product&dir=<?= ($sort_by == 'Product' && $sort_dir == 'asc') ? 'desc' : 'asc' ?>&search=<?= urlencode($search) ?>&search_field=<?= $search_field ?>&page=<?= $page ?>">
                                        Produit
                                ...
                                <th>
                                    <a href="?sort=Vendor&dir=<?= ($sort_by == 'Vendor' && $sort_dir == 'asc') ? 'desc' : 'asc' ?>&search=<?= urlencode($search) ?>&search_field=<?= $search_field ?>&page=<?= $page ?>">
                                        Vendeur
                                ...
                                <th>
                                    <a href="?sort=Category&dir=<?= ($sort_by == 'Category' && $sort_dir == 'asc') ? 'desc' : 'asc' ?>&search=<?= urlencode($search) ?>&search_field=<?= $search_field ?>&page=<?= $page ?>">
                                        Catégorie
                                ...
                                <th>
                                    <a href="?sort=Family&dir=<?= ($sort_by == 'Family' && $sort_dir == 'asc') ? 'desc' : 'asc' ?>&search=<?= urlencode($search) ?>&search_field=<?= $search_field ?>&page=<?= $page ?>">
                                        Famille
                                        <?php if ($sort_by == 'Family'): ?>
                                            <span class="sort-icon"><i class="bi bi-arrow-<?= $sort_dir == 'asc' ? 'up' : 'down' ?>"></i></span>
                                        <?php endif; ?>
                                    </a>
                                </th>
                                <th class="text-center">
                                    <a href="?sort=Nombre_Vulnerabilites&dir=<?= ($sort_by == 'Nombre_Vulnerabilites' && $sort_dir == 'asc') ? 'desc' : 'asc' ?>&search=<?= urlencode($search) ?>&search_field=<?= $search_field ?>&page=<?= $page ?>">
                                        Vulnérabilités
                ...
                <?php if ($total_pages > 1): ?>
                    <nav aria-label="Pagination" class="mt-3">
                        <ul class="pagination justify-content-center">
                            ...
                            if ($start_page > 1): ?>
                                <li class="page-item">
                                    <a class="page-link" href="?page=1&sort=<?= $sort_by ?>&dir=<?= $sort_dir ?>&search=<?= urlencode($search) ?>&search_field=<?= $search_field ?>">1</a>
                                </li>
                                <?php if ($start_page > 2): ?>
                            ...
                            if ($end_page < $total_pages): ?>
                                ...
                                <?php endif; ?>
                                <li class="page-item">
                                    <a class="page-link" href="?page=<?= $total_pages ?>&sort=<?= $sort_by ?>&dir=<?= $sort_dir ?>&search=<?= urlencode($search) ?>&search_field=<?= $search_field ?>">
                                        <?= $total_pages ?>
                                    </a>
                                </li>
                            <?php endif; ?>
