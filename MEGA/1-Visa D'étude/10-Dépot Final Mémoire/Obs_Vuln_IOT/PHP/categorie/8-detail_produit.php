...
$csv_file = '/Users/abderaoufbouhali/PycharmProjects/Mémoire/produit/'. $annee_analysee .'/5-produits_avec_familles_et_cve_severity_tmpc_score_cwe.csv';
...
.container {
    max-width: 1140px; /* Légèrement plus petit que 1200px */
    margin: 0 auto;
    background-color: #fff;
...
.severity-count {
    font-size: 18px; /* Réduit de 22px à 18px */
    font-weight: bold;
    margin: 5px 0; /* Réduit de 10px à 5px */
}
...
.vulnerabilities-table {
    ...
    overflow: hidden;
    box-shadow: 0 0 5px rgba(0,0,0,0.05);
    border: 1px solid #000; /* Bordure noire comme demandé précédemment */
}

.vulnerabilities-table th {
    background-color: #000; /* Noir comme demandé précédemment */
    color: #fff;
    text-align: left;
...
.vulnerabilities-table td {
    padding: 6px 8px; /* Réduit de 12px à 6px-8px */
    border: 1px solid #000; /* Bordure noire */
    font-size: 13px; /* Réduit de 14px à 13px */
}
...
h2 {
    background-color: #f8f8f8;
    padding: 8px 10px; /* Réduit de 10px 15px à 8px 10px */
    border-left: 4px solid #0d6efd;
...
.pagination .page-item .page-link {
    padding: 4px 12px; /* Réduit de 8px 16px à 4px 12px */
    font-size: 13px;
}
...
/* Footer plus compact */
footer {
    margin-top: 20px !important; /* Réduit de mt-5 (3rem) à 20px */
    padding-top: 10px !important; /* Réduit de pt-4 (1.5rem) à 10px */
}
...
<body>
    <div class="container">
        ...
        <div class="page-header">
            ...
            <a href="4-liste_produit_catg_fam.php" class="back-btn">
