...
input_directory = 'results/4-vendeurs/h'  # Dossier contenant les fichiers CSV
output_file = 'results/4-vendeurs/h/liste_vendeur_h_solo-nist.csv'  # Fichier qui contiendra les noms des fichiers
